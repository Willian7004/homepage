...
st.write("对于性能要求不高的使用场景，二手CPU也有其它方案。希望用低成本运行主流桌面程序特别是需要核显时可以选至强E3 v3系列，性能略高于第九代酷睿i3。用于嵌入式场景可以考虑瘦客户机。")
st.write("补充：其它性价比较高的二手消费级CPU，主要用于低端方案：闪龙3850、A8 7650k、A10 7860k")