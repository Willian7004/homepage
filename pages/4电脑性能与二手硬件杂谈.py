...
st.sidebar.write("6.关于普通桌面应用的性能要求")
...
st.write("这里的普通桌面应用指对性能要求不高且一般用户有机会接触的使用场景，现在这类应用相比早期桌面应用的性能要求高很多。早期性能要求提升主要是因为功能扩展，后来功能基本达到上限；在互联网时代不少企业使用web技术简化开发，性能要求也有一定提升，但一般来说电脑2代i7以上、手机骁龙845以上（流畅度要求高的话可以选性能高一些的）就够用了。")
